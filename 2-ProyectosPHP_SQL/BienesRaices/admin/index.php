<?php 
    ...
    if($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        if($id) {
            ...
            // Eliminar el archivo
            $query = "SELECT imagen FROM propiedades WHERE idpropiedades = ${idpropiedades}";
            ...
            <tbody> <!-- Mostrar los Resultados -->
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="/bienesraices/admin/propiedades/actualizar.php?id=<?php echo $propiedad['idpropiedades']; ?>" class="boton-amarillo-block">Actualizar</a>
                    </td>
                </tr>
                <?php endwhile; ?>
            </tbody>
